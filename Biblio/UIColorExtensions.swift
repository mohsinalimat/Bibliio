...
extension UIColor {
    ...
    static func deepBlue() -> UIColor {
        return UIColor.init(red: 65/255.0, green: 110/255.0, blue: 177/255.0, alpha: 1)
    }
    
    static func lightGreen() -> UIColor {
        return UIColor.init(red: 125/255.0, green: 211/255.0, blue: 124/255.0, alpha: 1)
    }
    
    static func jade() -> UIColor {
        return UIColor.init(red: 21/255.0, green: 165/255.0, blue: 55/255.0, alpha: 1)
    }
}
